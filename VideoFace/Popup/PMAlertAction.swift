...
@objc open class PMAlertAction: UIButton {
    ...
    @objc public convenience init(title: String?, style: PMAlertActionStyle, action: (() -> Void)? = nil){
        ...
        style == .default ? (self.setTitleColor(UIColor(red: 191.0/255.0, green: 51.0/255.0, blue: 98.0/255.0, alpha: 1.0), for: UIControlState.normal)) : (self.setTitleColor(UIColor.gray, for: UIControlState.normal))
